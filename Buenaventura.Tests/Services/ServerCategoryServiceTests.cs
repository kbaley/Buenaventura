...
public class ServerCategoryServiceTests : IClassFixture<TestDbContextFixture>
{
    private readonly TestDbContextFixture _fixture;
    private readonly ServerCategoryService _service;

    public ServerCategoryServiceTests(TestDbContextFixture fixture)
    {
        _fixture = fixture;
        _service = new ServerCategoryService(_fixture.Context);
    }
