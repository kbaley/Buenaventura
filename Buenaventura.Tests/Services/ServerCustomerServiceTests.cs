...
public class ServerCustomerServiceTests : IClassFixture<TestDbContextFixture>
{
    private readonly TestDbContextFixture _fixture;
    private readonly ServerCustomerService _service;

    public ServerCustomerServiceTests(TestDbContextFixture fixture)
    {
        _fixture = fixture;
        _service = new ServerCustomerService(_fixture.Context);
    }
