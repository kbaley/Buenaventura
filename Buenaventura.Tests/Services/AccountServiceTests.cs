...
public class AccountServiceTests : IClassFixture<TestDbContextFixture>
{
    private readonly TestDbContextFixture _fixture;
    private readonly Mock<ITransactionRepository> _mockTransactionRepo;
    private readonly AccountService _service;

    public AccountServiceTests(TestDbContextFixture fixture)
    {
        _fixture = fixture;
        _mockTransactionRepo = new Mock<ITransactionRepository>();
        _service = new AccountService(_fixture.Context, _mockTransactionRepo.Object);
    }
    ...
    public async Task GetAccounts_ReturnsAccountsWithBalances()
    {
        ...
        // Act
        var result = (await _service.GetAccounts()).ToList();
