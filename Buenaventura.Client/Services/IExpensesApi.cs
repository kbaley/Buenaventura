...
public interface IExpensesApi
{
    ...
    /// </summary>
    [Get("/api/expenses?includeTags={includeTags}&excludeTags={excludeTags}&allTime={allTime}")]
    Task<IEnumerable<ReportDataPoint>> GetExpenseCategoryBreakdown(string includeTags = "", string excludeTags = "", bool allTime = false);
    ...
    /// </summary>
    [Get("/api/expenses/totalsbymonth?includeTags={includeTags}&excludeTags={excludeTags}&allTime={allTime}")]
    Task<CategoryTotals> GetExpenseTotalsByMonth(string includeTags = "", string excludeTags = "", bool allTime = false);
    ...
    [Get("/api/expenses/vendors?includeTags={includeTags}&excludeTags={excludeTags}&allTime={allTime}")]
    Task<List<ReportDataPoint>> GetVendorData(string includeTags = "", string excludeTags = "", bool allTime = false);
}
