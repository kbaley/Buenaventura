...
namespace Buenaventura.Migrations
{
    ...
    [Migration("20260520135653_ReimbursementsMigration")]
    partial class ReimbursementsMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Buenaventura.Domain.Category", b =>
                {
                    ...
                    b.Property<bool>("ExcludeFromTransactionReport")
                        .HasColumnType("boolean")
                        .HasColumnName("exclude_from_transaction_report");
            ...
            modelBuilder.Entity("Buenaventura.Domain.ReimbursementMatch", b =>
                {
                    b.Property<Guid>("ReimbursementMatchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("reimbursement_match_id");

                    b.Property<string>("AcceptedDifferenceReason")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("accepted_difference_reason");
                    ...
                    b.Property<Guid>("ReimbursementSettlementId")
                        .HasColumnType("uuid")
                        .HasColumnName("reimbursement_settlement_id");

                    b.HasKey("ReimbursementMatchId")
                        .HasName("pk_reimbursement_matches");

                    b.HasIndex("ReimbursementSettlementId")
                        .HasDatabaseName("ix_reimbursement_matches_reimbursement_settlement_id");

                    b.ToTable("reimbursement_matches", (string)null);
                });

            modelBuilder.Entity("Buenaventura.Domain.ReimbursementMatchTransaction", b =>
                {
                    b.Property<Guid>("ReimbursementMatchId")
                        .HasColumnType("uuid")
                        .HasColumnName("reimbursement_match_id");
                    ...
                    b.HasKey("ReimbursementMatchId", "TransactionId")
                        .HasName("pk_reimbursement_match_transactions");

                    b.HasIndex("TransactionId")
                        .HasDatabaseName("ix_reimbursement_match_transactions_transaction_id");

                    b.ToTable("reimbursement_match_transactions", (string)null);
                });

            modelBuilder.Entity("Buenaventura.Domain.ReimbursementSettlement", b =>
                {
                    b.Property<Guid>("ReimbursementSettlementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("ReimbursementSettlementId")
                        .HasName("pk_reimbursement_settlements");

                    b.ToTable("reimbursement_settlements", (string)null);
                });
            ...
            modelBuilder.Entity("Buenaventura.Domain.Transaction", b =>
                {
                    ...
                    b.HasIndex("ReimbursementSettlementId")
                        .HasDatabaseName("ix_transactions_reimbursement_settlement_id");
            ...
            modelBuilder.Entity("Buenaventura.Domain.ReimbursementMatch", b =>
                {
                    b.HasOne("Buenaventura.Domain.ReimbursementSettlement", "Settlement")
                        .WithMany("Matches")
                        .HasForeignKey("ReimbursementSettlementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reimbursement_matches_reimbursement_settlements_reimburseme");
            ...
            modelBuilder.Entity("Buenaventura.Domain.ReimbursementMatchTransaction", b =>
                {
                    b.HasOne("Buenaventura.Domain.ReimbursementMatch", "Match")
                        .WithMany("MatchTransactions")
                        .HasForeignKey("ReimbursementMatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reimbursement_match_transactions_reimbursement_matches_reim");

                    b.HasOne("Buenaventura.Domain.Transaction", "Transaction")
                        .WithMany("ReimbursementMatchTransactions")
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reimbursement_match_transactions_transactions_transaction_id");
            ...
            modelBuilder.Entity("Buenaventura.Domain.Transaction", b =>
                {
                    ...
                    b.HasOne("Buenaventura.Domain.ReimbursementSettlement", "ReimbursementSettlement")
                        .WithMany("Transactions")
                        .HasForeignKey("ReimbursementSettlementId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_transactions_reimbursement_settlements_reimbursement_settle");
                    ...
                    b.Navigation("ReimbursementSettlement");
                });
            ...
            modelBuilder.Entity("Buenaventura.Domain.ReimbursementMatch", b =>
                {
                    b.Navigation("MatchTransactions");
                });
            ...
            modelBuilder.Entity("Buenaventura.Domain.Transaction", b =>
                {
                    ...
                    b.Navigation("ReimbursementMatchTransactions");
